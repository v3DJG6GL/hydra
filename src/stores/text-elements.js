    ...
    en: {
        translation: {
            ...
            panel: {
                ...
                'assign': 'MIDI assign mode: tap a value row, scene pad or HUSH, then move a knob or hit a pad — one tap per mapping. Tap again (or Esc) to exit',
                'assign-hint': 'assign mode — tap a row, then move a knob or hit a pad',
                ...
                'led-feedback-hint': 'works on controllers whose LEDs accept MIDI echo (set Korg nano* to external LED mode)',
