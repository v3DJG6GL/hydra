...
export function captureThumb(hydra, cb) {
    // captureFrame serializes against the preview frame loop (overlapping
    // getScreenImage calls make hydra-synth download a PNG) and handles the
    // don't-hang timeout itself
    captureFrame(hydra, (blob) => {
